...
export default function CoffeeCanvas() {
  ...
  const beatADisplay = useTransform(scrollYProgress, (p) => (p > 0.12 ? "none" : "flex"));
  ...
  const beatBDisplay = useTransform(scrollYProgress, (p) => (p < 0.1 || p > 0.22 ? "none" : "flex"));
  ...
  const beatCDisplay = useTransform(scrollYProgress, (p) => (p < 0.2 || p > 0.32 ? "none" : "flex"));
  ...
  const beatDDisplay = useTransform(scrollYProgress, (p) => (p < 0.3 || p > 0.42 ? "none" : "flex"));
  ...
  const ingredientsDisplay = useTransform(scrollYProgress, (p) => (p < 0.4 || p > 0.52 ? "none" : "block"));
  ...
  const s1Display = useTransform(scrollYProgress, (p) => (p < 0.5 || p > 0.65 ? "none" : "flex"));
  ...
  const s2Display = useTransform(scrollYProgress, (p) => (p < 0.63 || p > 0.8 ? "none" : "flex"));
  ...
  const s3Display = useTransform(scrollYProgress, (p) => (p < 0.78 || p > 0.93 ? "none" : "flex"));
  ...
  const sigDisplay = useTransform(scrollYProgress, (p) => (p < 0.91 ? "none" : "flex"));
    ...
    <div ref={containerRef} className="h-[1000vh] w-full relative bg-brand-dark">
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none no-select flex flex-col justify-center">
          ...
          {/* Beat A */}
          <motion.div style={{ opacity: beatAOpacity, y: beatAY, display: beatADisplay }} className="absolute inset-0 flex items-center justify-center px-6">
          ...
          {/* Beat B */}
          <motion.div style={{ opacity: beatBOpacity, x: beatBX, display: beatBDisplay }} className="absolute inset-0 flex items-center justify-start px-6 md:pl-24">
          ...
          {/* Beat C */}
          <motion.div style={{ opacity: beatCOpacity, x: beatCX, display: beatCDisplay }} className="absolute inset-0 flex items-center justify-end px-6 md:pr-24">
          ...
          {/* Beat D */}
          <motion.div style={{ opacity: beatDOpacity, scale: beatDScale, display: beatDDisplay }} className="absolute inset-0 flex items-center justify-center px-6">
          ...
          {/* Ingredients Reveal */}
          <motion.div style={{ opacity: ingredientsOpacity, display: ingredientsDisplay }} className="absolute inset-0 hidden md:block">
            {/* Top Label */}
          ...
          <motion.div style={{ opacity: s1Opacity, y: s1Y, display: s1Display }} className="absolute inset-0 flex flex-col items-center justify-center px-6 bg-brand-dark/80">
          ...
          <motion.div style={{ opacity: s2Opacity, y: s2Y, display: s2Display }} className="absolute inset-0 flex items-center justify-center px-6 md:px-24 bg-brand-dark/90">
          ...
          <motion.div style={{ opacity: s3Opacity, scale: s3Scale, display: s3Display }} className="absolute inset-0 flex flex-col items-center justify-center bg-brand-dark/95">
          ...
          {/* Signature Quote & CTA */}
          <motion.div style={{ opacity: sigOpacity, y: sigY, display: sigDisplay }} className="absolute inset-0 flex flex-col items-center justify-center bg-brand-dark">
